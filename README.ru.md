...
**Или поставьте как плагин Claude Code** — регистрирует команду `/open-geo` и её
рабочих агентов в любой сессии:
...
> Плагин — обёртка для установки: сам пайплайн по-прежнему работает из клона репозитория
> (шаги 1–2 выше), и команда прямо скажет об этом, если вызвать её вне клона.
